...
| `GAME_STATE_TRAINING_ENABLED` | `false` by default. Lets the game-state extraction pass maintain per-game UI-decoding notes for itself (self-training — see [Passive game-state awareness](#passive-game-state-awareness)). |
